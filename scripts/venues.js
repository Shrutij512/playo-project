...
async function searchLocation() {
    ...
    let response = await fetch("../playo-project/database/bookvenue.json");
    ...
    let filterData = data.filter((el) => {
        ...
        // console.log(el.location == search_value);
        // return (el.location === search_value || el.name === search_value);
    })
...
// const debouncingFunction = async function(fetchFunction, delay) {
